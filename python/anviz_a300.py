...
if __name__ == '__main__':
    clock = Device(device_id=1, ip_addr='192.168.3.33', ip_port=5010)
    #print(clock.get_datetime())
    #print(clock.get_information())
    #print(clock.get_net_params())
    #print(clock.get_record_info())
    print(clock.download_records())
    ##print(clock.download_staff_info())
